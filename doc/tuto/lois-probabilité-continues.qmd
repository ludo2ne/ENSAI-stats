...
$$X_1 + X_2 \sim \mathcal{N}(\mu_1 + \mu_2,\sigma_1^2 + \sigma_2^2) \Leftrightarrow X_1 \sim \mathcal{N}(\mu_1,\sigma_1^2) \ et \ X_2 \sim \mathcal{N}(\mu_2,\sigma_2^2) \ et \ X \perp \!\!\! \perp Y$$
